...
/*
 * 
 * This is a POJO Class to update program by name
 * 
 */


public class UpdateProgramByNamePOJO {
	...
	static UpdateProgramByNamePOJO programpayload;
	static String jsonBody;
	
	public static void  programmodule() throws InvalidFormatException, IOException {
		
		
		//List<Map<String, String>>map = ExcelReaderRest.getData(URLs.PgmModuleExcelpath,"updateprogrambyname");
		
		List<Map<String, String>>map = ExcelReader_Rest.getData(URLs.PgmModuleExcelpath,"updateprogrambyname");
		for (Map<String, String> row : map) {
		 ...
		 programpayload= new UpdateProgramByNamePOJO();
